...
if (isset($jsonData['inventory'][$productName])) {
    ...
    $jsonData['inventory'][$productName] = intval($jsonData['inventory'][$productName]) + $removedQuantity;
    ...
    if (isset($jsonData['inventory'][$itemName])) {
        // Product found, update the quantity
        $jsonData['inventory'][$itemName] = intval($jsonData['inventory'][$itemName]) + $removedQuantity;
...
// if (isset($jsonData['inventory'][$productName])) {
//     // Product found, update the quantity
//     $jsonData['inventory'][$productName] = intval($jsonData['inventory'][$productName]) - 1;
