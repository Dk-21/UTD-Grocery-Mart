...
$host = 'localhost'; // or the appropriate host name
$dbname = 'UTDMart'; // replace with your database name
$username = 'admin'; // default MAMP username
$password = 'password'; // default MAMP password
